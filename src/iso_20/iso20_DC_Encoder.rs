...
unsafe extern "C" fn encode_iso20_dc_TransformType(
    stream: &mut ExiBitstream,
    mut TransformType: *const iso20_dc_TransformType,
) -> i32 {
...
unsafe extern "C" fn encode_iso20_dc_TransformsType(
    stream: &mut ExiBitstream,
    mut TransformsType: *const iso20_dc_TransformsType,
) -> i32 {
...
unsafe extern "C" fn encode_iso20_dc_DSAKeyValueType(
    stream: &mut ExiBitstream,
    mut DSAKeyValueType: *const iso20_dc_DSAKeyValueType,
) -> i32 {
...
unsafe extern "C" fn encode_iso20_dc_X509IssuerSerialType(
    stream: &mut ExiBitstream,
    mut X509IssuerSerialType: *const iso20_dc_X509IssuerSerialType,
) -> i32 {
...
unsafe extern "C" fn encode_iso20_dc_DigestMethodType(
    stream: &mut ExiBitstream,
    mut DigestMethodType: *const iso20_dc_DigestMethodType,
) -> i32 {
...
unsafe extern "C" fn encode_iso20_dc_RSAKeyValueType(
    stream: &mut ExiBitstream,
    mut RSAKeyValueType: *const iso20_dc_RSAKeyValueType,
) -> i32 {
...
unsafe extern "C" fn encode_iso20_dc_CanonicalizationMethodType(
    stream: &mut ExiBitstream,
    mut CanonicalizationMethodType: *const iso20_dc_CanonicalizationMethodType,
) -> i32 {
...
unsafe extern "C" fn encode_iso20_dc_SignatureMethodType(
    stream: &mut ExiBitstream,
    mut SignatureMethodType: *const iso20_dc_SignatureMethodType,
) -> i32 {
...
unsafe extern "C" fn encode_iso20_dc_KeyValueType(
    stream: &mut ExiBitstream,
    mut KeyValueType: *const iso20_dc_KeyValueType,
) -> i32 {
        ...
        match grammar_id {
            24 => {
                if (*KeyValueType).DSAKeyValue_isUsed() == 1 as u32 {
                    ...
                    if error == 0 as i32 {
                        error =
                            encode_iso20_dc_DSAKeyValueType(stream, &(*KeyValueType).DSAKeyValue);
                        if error == 0 as i32 {
                            grammar_id = 2 as i32;
                        }
                    }
                    ...
                    if error == 0 as i32 {
                        error =
                            encode_iso20_dc_RSAKeyValueType(stream, &(*KeyValueType).RSAKeyValue);
                        if error == 0 as i32 {
                            grammar_id = 2 as i32;
                        }
                    }
...
unsafe extern "C" fn encode_iso20_dc_ReferenceType(
    stream: &mut ExiBitstream,
    mut ReferenceType: *const iso20_dc_ReferenceType,
) -> i32 {
        ...
        match grammar_id {
            25 => {
                if (*ReferenceType).Id_isUsed() == 1 as u32 {
                    ...
                    if error == 0 as i32 {
                        error =
                            encode_iso20_dc_TransformsType(stream, &(*ReferenceType).Transforms);
                        if error == 0 as i32 {
                    ...
                    if error == 0 as i32 {
                        error = encode_iso20_dc_DigestMethodType(
                            stream,
            ...
            29 => {
                ...
                if error == 0 as i32 {
                    error =
                        encode_iso20_dc_DigestMethodType(stream, &(*ReferenceType).DigestMethod);
                    if error == 0 as i32 {
                        grammar_id = 30 as i32;
                    }
                }
...
unsafe extern "C" fn encode_iso20_dc_RetrievalMethodType(
    stream: &mut ExiBitstream,
    mut RetrievalMethodType: *const iso20_dc_RetrievalMethodType,
) -> i32 {
            ...
            31 => {
                if (*RetrievalMethodType).Type_isUsed() == 1 as u32 {
                    ...
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 2 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_TransformsType(
                            stream,
...
unsafe extern "C" fn encode_iso20_dc_X509DataType(
    stream: &mut ExiBitstream,
    mut X509DataType: *const iso20_dc_X509DataType,
) -> i32 {
            ...
            34 => {
                if (*X509DataType).X509IssuerSerial_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_X509IssuerSerialType(
                            stream,
...
unsafe extern "C" fn encode_iso20_dc_PGPDataType(
    stream: &mut ExiBitstream,
    mut PGPDataType: *const iso20_dc_PGPDataType,
) -> i32 {
...
unsafe extern "C" fn encode_iso20_dc_SPKIDataType(
    stream: &mut ExiBitstream,
    mut SPKIDataType: *const iso20_dc_SPKIDataType,
) -> i32 {
...
unsafe extern "C" fn encode_iso20_dc_SignedInfoType(
    stream: &mut ExiBitstream,
    mut SignedInfoType: *const iso20_dc_SignedInfoType,
) -> i32 {
    ...
    while done == 0 {
        match grammar_id {
            42 => {
                if (*SignedInfoType).Id_isUsed() == 1 as u32 {
                    ...
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 1 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_CanonicalizationMethodType(
                            stream,
            ...
            44 => {
                error = exi_basetypes_encoder_nbit_uint(stream, 1 as i32 as usize, 0 as i32 as u32);
                if error == 0 as i32 {
                    error = encode_iso20_dc_SignatureMethodType(
                        stream,
            ...
            45 => {
                if (Reference_currentIndex as i32) < (*SignedInfoType).Reference.arrayLen as i32 {
                    ...
                    if error == 0 as i32 {
                        ...
                        error = encode_iso20_dc_ReferenceType(
                            stream,
...
unsafe extern "C" fn encode_iso20_dc_SignatureValueType(
    stream: &mut ExiBitstream,
    mut SignatureValueType: *const iso20_dc_SignatureValueType,
) -> i32 {
...
unsafe extern "C" fn encode_iso20_dc_KeyInfoType(
    stream: &mut ExiBitstream,
    mut KeyInfoType: *const iso20_dc_KeyInfoType,
) -> i32 {
        ...
        match grammar_id {
            49 => {
                if (*KeyInfoType).Id_isUsed() == 1 as u32 {
                    ...
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RetrievalMethodType(
                            stream,
...
unsafe extern "C" fn encode_iso20_dc_ObjectType(
    stream: &mut ExiBitstream,
    mut ObjectType: *const iso20_dc_ObjectType,
) -> i32 {
...
unsafe extern "C" fn encode_iso20_dc_RationalNumberType(
    stream: &mut ExiBitstream,
    mut RationalNumberType: *const iso20_dc_RationalNumberType,
) -> i32 {
...
unsafe extern "C" fn encode_iso20_dc_DetailedCostType(
    stream: &mut ExiBitstream,
    mut DetailedCostType: *const iso20_dc_DetailedCostType,
) -> i32 {
    ...
    while done == 0 {
        match grammar_id {
            ...
            58 => {
                error = exi_basetypes_encoder_nbit_uint(stream, 1 as i32 as usize, 0 as i32 as u32);
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
...
unsafe extern "C" fn encode_iso20_dc_SignatureType(
    stream: &mut ExiBitstream,
    mut SignatureType: *const iso20_dc_SignatureType,
) -> i32 {
        ...
        match grammar_id {
            59 => {
                if (*SignatureType).Id_isUsed() == 1 as u32 {
                    ...
                    if error == 0 as i32 {
                        error =
                            encode_iso20_dc_SignedInfoType(stream, &(*SignatureType).SignedInfo);
                        if error == 0 as i32 {
            ...
            61 => {
                error = exi_basetypes_encoder_nbit_uint(stream, 1 as i32 as usize, 0 as i32 as u32);
                if error == 0 as i32 {
                    error = encode_iso20_dc_SignatureValueType(
                        stream,
...
unsafe extern "C" fn encode_iso20_dc_DetailedTaxType(
    stream: &mut ExiBitstream,
    mut DetailedTaxType: *const iso20_dc_DetailedTaxType,
) -> i32 {
...
unsafe extern "C" fn encode_iso20_dc_MessageHeaderType(
    stream: &mut ExiBitstream,
    mut MessageHeaderType: *const iso20_dc_MessageHeaderType,
) -> i32 {
        ...
        match grammar_id {
            ...
            70 => {
                if (*MessageHeaderType).Signature_isUsed() == 1 as u32 {
                    ...
                    if error == 0 as i32 {
                        error =
                            encode_iso20_dc_SignatureType(stream, &(*MessageHeaderType).Signature);
                        if error == 0 as i32 {
                            grammar_id = 2 as i32;
                        }
                    }
...
unsafe extern "C" fn encode_iso20_dc_SignaturePropertyType(
    stream: &mut ExiBitstream,
    mut SignaturePropertyType: *const iso20_dc_SignaturePropertyType,
) -> i32 {
...
unsafe extern "C" fn encode_iso20_dc_DC_CPDReqEnergyTransferModeType(
    stream: &mut ExiBitstream,
    mut DC_CPDReqEnergyTransferModeType: *const iso20_dc_DC_CPDReqEnergyTransferModeType,
) -> i32 {
        ...
        match grammar_id {
            74 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*DC_CPDReqEnergyTransferModeType).EVMaximumChargePower,
                    );
                    if error == 0 as i32 {
            ...
            75 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*DC_CPDReqEnergyTransferModeType).EVMinimumChargePower,
                    );
                    if error == 0 as i32 {
            ...
            76 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*DC_CPDReqEnergyTransferModeType).EVMaximumChargeCurrent,
                    );
                    if error == 0 as i32 {
            ...
            77 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*DC_CPDReqEnergyTransferModeType).EVMinimumChargeCurrent,
                    );
                    if error == 0 as i32 {
            ...
            78 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*DC_CPDReqEnergyTransferModeType).EVMaximumVoltage,
                    );
                    if error == 0 as i32 {
            ...
            79 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*DC_CPDReqEnergyTransferModeType).EVMinimumVoltage,
                    );
                    if error == 0 as i32 {
            ...
            80 => {
                if (*DC_CPDReqEnergyTransferModeType).TargetSOC_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
                        ...
                        if error == 0 as i32 {
                            error = exi_basetypes_encoder_nbit_uint(
                                stream,
                                7 as i32 as usize,
                                (*DC_CPDReqEnergyTransferModeType).TargetSOC as u32,
                            );
                            if error == 0 as i32 {
                                error = exi_basetypes_encoder_nbit_uint(
                                    stream,
...
unsafe extern "C" fn encode_iso20_dc_DisplayParametersType(
    stream: &mut ExiBitstream,
    mut DisplayParametersType: *const iso20_dc_DisplayParametersType,
) -> i32 {
...
unsafe extern "C" fn encode_iso20_dc_DC_CPDResEnergyTransferModeType(
    stream: &mut ExiBitstream,
    mut DC_CPDResEnergyTransferModeType: *const iso20_dc_DC_CPDResEnergyTransferModeType,
) -> i32 {
        ...
        match grammar_id {
            91 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*DC_CPDResEnergyTransferModeType).EVSEMaximumChargePower,
                    );
                    if error == 0 as i32 {
            ...
            92 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*DC_CPDResEnergyTransferModeType).EVSEMinimumChargePower,
                    );
                    if error == 0 as i32 {
            ...
            93 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*DC_CPDResEnergyTransferModeType).EVSEMaximumChargeCurrent,
                    );
                    if error == 0 as i32 {
            ...
            94 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*DC_CPDResEnergyTransferModeType).EVSEMinimumChargeCurrent,
                    );
                    if error == 0 as i32 {
            ...
            95 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*DC_CPDResEnergyTransferModeType).EVSEMaximumVoltage,
                    );
                    if error == 0 as i32 {
            ...
            96 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*DC_CPDResEnergyTransferModeType).EVSEMinimumVoltage,
                    );
                    if error == 0 as i32 {
            ...
            97 => {
                if (*DC_CPDResEnergyTransferModeType).EVSEPowerRampLimitation_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*DC_CPDResEnergyTransferModeType).EVSEPowerRampLimitation,
                        );
                        if error == 0 as i32 {
                            grammar_id = 2 as i32;
                        }
...
unsafe extern "C" fn encode_iso20_dc_EVSEStatusType(
    stream: &mut ExiBitstream,
    mut EVSEStatusType: *const iso20_dc_EVSEStatusType,
) -> i32 {
...
unsafe extern "C" fn encode_iso20_dc_MeterInfoType(
    stream: &mut ExiBitstream,
    mut MeterInfoType: *const iso20_dc_MeterInfoType,
) -> i32 {
...
unsafe extern "C" fn encode_iso20_dc_Dynamic_DC_CLReqControlModeType(
    stream: &mut ExiBitstream,
    mut Dynamic_DC_CLReqControlModeType: *const iso20_dc_Dynamic_DC_CLReqControlModeType,
) -> i32 {
    ...
    while done == 0 {
        match grammar_id {
            108 => {
                if (*Dynamic_DC_CLReqControlModeType).DepartureTime_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
                        ...
                        if error == 0 as i32 {
                            error = exi_basetypes_encoder_uint_32(
                                stream,
                                (*Dynamic_DC_CLReqControlModeType).DepartureTime,
                            );
                            if error == 0 as i32 {
                                error = exi_basetypes_encoder_nbit_uint(
                                    stream,
                    ...
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*Dynamic_DC_CLReqControlModeType).EVTargetEnergyRequest,
                        );
                        if error == 0 as i32 {
            ...
            110 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*Dynamic_DC_CLReqControlModeType).EVMaximumEnergyRequest,
                    );
                    if error == 0 as i32 {
            ...
            111 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*Dynamic_DC_CLReqControlModeType).EVMinimumEnergyRequest,
                    );
                    if error == 0 as i32 {
            ...
            112 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*Dynamic_DC_CLReqControlModeType).EVMaximumChargePower,
                    );
                    if error == 0 as i32 {
            ...
            113 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*Dynamic_DC_CLReqControlModeType).EVMinimumChargePower,
                    );
                    if error == 0 as i32 {
            ...
            114 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*Dynamic_DC_CLReqControlModeType).EVMaximumChargeCurrent,
                    );
                    if error == 0 as i32 {
            ...
            115 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*Dynamic_DC_CLReqControlModeType).EVMaximumVoltage,
                    );
                    if error == 0 as i32 {
            ...
            116 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*Dynamic_DC_CLReqControlModeType).EVMinimumVoltage,
                    );
                    if error == 0 as i32 {
                        grammar_id = 2 as i32;
                    }
...
unsafe extern "C" fn encode_iso20_dc_Scheduled_DC_CLReqControlModeType(
    stream: &mut ExiBitstream,
    mut Scheduled_DC_CLReqControlModeType: *const iso20_dc_Scheduled_DC_CLReqControlModeType,
) -> i32 {
    ...
    while done == 0 {
        match grammar_id {
            117 => {
                if (*Scheduled_DC_CLReqControlModeType).EVTargetEnergyRequest_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*Scheduled_DC_CLReqControlModeType).EVTargetEnergyRequest,
                        );
                        if error == 0 as i32 {
                            grammar_id = 118 as i32;
                        }
                    }
                } else if (*Scheduled_DC_CLReqControlModeType).EVMaximumEnergyRequest_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 1 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*Scheduled_DC_CLReqControlModeType).EVMaximumEnergyRequest,
                        );
                        if error == 0 as i32 {
                            grammar_id = 119 as i32;
                        }
                    }
                } else if (*Scheduled_DC_CLReqControlModeType).EVMinimumEnergyRequest_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 2 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*Scheduled_DC_CLReqControlModeType).EVMinimumEnergyRequest,
                        );
                        if error == 0 as i32 {
                    ...
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*Scheduled_DC_CLReqControlModeType).EVTargetCurrent,
                        );
                        if error == 0 as i32 {
            ...
            118 => {
                if (*Scheduled_DC_CLReqControlModeType).EVMaximumEnergyRequest_isUsed() == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
            ...
            119 => {
                if (*Scheduled_DC_CLReqControlModeType).EVMinimumEnergyRequest_isUsed() == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
            ...
            121 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*Scheduled_DC_CLReqControlModeType).EVTargetVoltage,
                    );
                    if error == 0 as i32 {
            ...
            122 => {
                if (*Scheduled_DC_CLReqControlModeType).EVMaximumChargePower_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*Scheduled_DC_CLReqControlModeType).EVMaximumChargePower,
                        );
                        if error == 0 as i32 {
                            grammar_id = 123 as i32;
                        }
                    }
                } else if (*Scheduled_DC_CLReqControlModeType).EVMinimumChargePower_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 1 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*Scheduled_DC_CLReqControlModeType).EVMinimumChargePower,
                        );
                        if error == 0 as i32 {
                            grammar_id = 124 as i32;
                        }
                    }
                } else if (*Scheduled_DC_CLReqControlModeType).EVMaximumChargeCurrent_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 2 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*Scheduled_DC_CLReqControlModeType).EVMaximumChargeCurrent,
                        );
                        if error == 0 as i32 {
                            grammar_id = 125 as i32;
                        }
                    }
                } else if (*Scheduled_DC_CLReqControlModeType).EVMaximumVoltage_isUsed() == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 3 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*Scheduled_DC_CLReqControlModeType).EVMaximumVoltage,
                        );
                        if error == 0 as i32 {
                            grammar_id = 126 as i32;
                        }
                    }
                } else if (*Scheduled_DC_CLReqControlModeType).EVMinimumVoltage_isUsed() == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 4 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*Scheduled_DC_CLReqControlModeType).EVMinimumVoltage,
                        );
                        if error == 0 as i32 {
                            grammar_id = 2 as i32;
                        }
            ...
            123 => {
                if (*Scheduled_DC_CLReqControlModeType).EVMinimumChargePower_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
            ...
            124 => {
                if (*Scheduled_DC_CLReqControlModeType).EVMaximumChargeCurrent_isUsed() == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
            ...
            125 => {
                if (*Scheduled_DC_CLReqControlModeType).EVMaximumVoltage_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
            ...
            126 => {
                if (*Scheduled_DC_CLReqControlModeType).EVMinimumVoltage_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
...
unsafe extern "C" fn encode_iso20_dc_CLReqControlModeType(
    stream: &mut ExiBitstream,
    mut CLReqControlModeType: *const iso20_dc_CLReqControlModeType,
) -> i32 {
    let mut error: i32 =
        exi_basetypes_encoder_nbit_uint(stream, 1 as i32 as usize, 0 as i32 as u32);
    return error;
}
unsafe extern "C" fn encode_iso20_dc_ReceiptType(
    stream: &mut ExiBitstream,
    mut ReceiptType: *const iso20_dc_ReceiptType,
) -> i32 {
        ...
        match grammar_id {
            ...
            128 => {
                if (*ReceiptType).EnergyCosts_isUsed() == 1 as u32 {
                    ...
                    if error == 0 as i32 {
                        error =
                            encode_iso20_dc_DetailedCostType(stream, &(*ReceiptType).EnergyCosts);
                        if error == 0 as i32 {
                    ...
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 1 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_DetailedCostType(
                            stream,
                    ...
                    if error == 0 as i32 {
                        error =
                            encode_iso20_dc_DetailedCostType(stream, &(*ReceiptType).OverstayCosts);
                        if error == 0 as i32 {
                    ...
                    if error == 0 as i32 {
                        ...
                        error = encode_iso20_dc_DetailedTaxType(
                            stream,
...
unsafe extern "C" fn encode_iso20_dc_Dynamic_DC_CLResControlModeType(
    stream: &mut ExiBitstream,
    mut Dynamic_DC_CLResControlModeType: *const iso20_dc_Dynamic_DC_CLResControlModeType,
) -> i32 {
    ...
    while done == 0 {
        match grammar_id {
            138 => {
                if (*Dynamic_DC_CLResControlModeType).DepartureTime_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
                        ...
                        if error == 0 as i32 {
                            error = exi_basetypes_encoder_uint_32(
                                stream,
                                (*Dynamic_DC_CLResControlModeType).DepartureTime,
                            );
                            if error == 0 as i32 {
                                error = exi_basetypes_encoder_nbit_uint(
                                    stream,
                ...
                } else if (*Dynamic_DC_CLResControlModeType).MinimumSOC_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 1 as i32 as u32);
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
                        ...
                        if error == 0 as i32 {
                            error = exi_basetypes_encoder_nbit_uint(
                                stream,
                                7 as i32 as usize,
                                (*Dynamic_DC_CLResControlModeType).MinimumSOC as u32,
                            );
                            if error == 0 as i32 {
                                error = exi_basetypes_encoder_nbit_uint(
                                    stream,
                ...
                } else if (*Dynamic_DC_CLResControlModeType).TargetSOC_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 2 as i32 as u32);
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
                        ...
                        if error == 0 as i32 {
                            error = exi_basetypes_encoder_nbit_uint(
                                stream,
                                7 as i32 as usize,
                                (*Dynamic_DC_CLResControlModeType).TargetSOC as u32,
                            );
                            if error == 0 as i32 {
                                error = exi_basetypes_encoder_nbit_uint(
                                    stream,
                ...
                } else if (*Dynamic_DC_CLResControlModeType).AckMaxDelay_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 3 as i32 as u32);
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
                        ...
                        if error == 0 as i32 {
                            error = exi_basetypes_encoder_uint_16(
                                stream,
                                (*Dynamic_DC_CLResControlModeType).AckMaxDelay,
                            );
                            if error == 0 as i32 {
                                error = exi_basetypes_encoder_nbit_uint(
                                    stream,
                    ...
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*Dynamic_DC_CLResControlModeType).EVSEMaximumChargePower,
                        );
                        if error == 0 as i32 {
            ...
            139 => {
                if (*Dynamic_DC_CLResControlModeType).MinimumSOC_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
            ...
            140 => {
                if (*Dynamic_DC_CLResControlModeType).TargetSOC_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
            ...
            141 => {
                if (*Dynamic_DC_CLResControlModeType).AckMaxDelay_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
            ...
            143 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*Dynamic_DC_CLResControlModeType).EVSEMinimumChargePower,
                    );
                    if error == 0 as i32 {
            ...
            144 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*Dynamic_DC_CLResControlModeType).EVSEMaximumChargeCurrent,
                    );
                    if error == 0 as i32 {
            ...
            145 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*Dynamic_DC_CLResControlModeType).EVSEMaximumVoltage,
                    );
                    if error == 0 as i32 {
                        grammar_id = 2 as i32;
                    }
...
unsafe extern "C" fn encode_iso20_dc_Scheduled_DC_CLResControlModeType(
    stream: &mut ExiBitstream,
    mut Scheduled_DC_CLResControlModeType: *const iso20_dc_Scheduled_DC_CLResControlModeType,
) -> i32 {
    ...
    while done == 0 {
        match grammar_id {
            146 => {
                if (*Scheduled_DC_CLResControlModeType).EVSEMaximumChargePower_isUsed() == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*Scheduled_DC_CLResControlModeType).EVSEMaximumChargePower,
                        );
                        if error == 0 as i32 {
                            grammar_id = 147 as i32;
                        }
                    }
                } else if (*Scheduled_DC_CLResControlModeType).EVSEMinimumChargePower_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 1 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*Scheduled_DC_CLResControlModeType).EVSEMinimumChargePower,
                        );
                        if error == 0 as i32 {
                            grammar_id = 148 as i32;
                        }
                    }
                } else if (*Scheduled_DC_CLResControlModeType).EVSEMaximumChargeCurrent_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 2 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*Scheduled_DC_CLResControlModeType).EVSEMaximumChargeCurrent,
                        );
                        if error == 0 as i32 {
                            grammar_id = 149 as i32;
                        }
                    }
                } else if (*Scheduled_DC_CLResControlModeType).EVSEMaximumVoltage_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 3 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*Scheduled_DC_CLResControlModeType).EVSEMaximumVoltage,
                        );
                        if error == 0 as i32 {
                            grammar_id = 2 as i32;
                        }
            ...
            147 => {
                if (*Scheduled_DC_CLResControlModeType).EVSEMinimumChargePower_isUsed() == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
            ...
            148 => {
                if (*Scheduled_DC_CLResControlModeType).EVSEMaximumChargeCurrent_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
            ...
            149 => {
                if (*Scheduled_DC_CLResControlModeType).EVSEMaximumVoltage_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
...
unsafe extern "C" fn encode_iso20_dc_CLResControlModeType(
    stream: &mut ExiBitstream,
    mut CLResControlModeType: *const iso20_dc_CLResControlModeType,
) -> i32 {
    let mut error: i32 =
        exi_basetypes_encoder_nbit_uint(stream, 1 as i32 as usize, 0 as i32 as u32);
    return error;
}
unsafe extern "C" fn encode_iso20_dc_DC_CableCheckReqType(
    stream: &mut ExiBitstream,
    mut DC_CableCheckReqType: *const iso20_dc_DC_CableCheckReqType,
) -> i32 {
    ...
    while done == 0 {
        match grammar_id {
            150 => {
                ...
                if error == 0 as i32 {
                    error =
                        encode_iso20_dc_MessageHeaderType(stream, &(*DC_CableCheckReqType).Header);
                    if error == 0 as i32 {
                        grammar_id = 2 as i32;
                    }
                }
...
unsafe extern "C" fn encode_iso20_dc_DC_CableCheckResType(
    stream: &mut ExiBitstream,
    mut DC_CableCheckResType: *const iso20_dc_DC_CableCheckResType,
) -> i32 {
    ...
    while done == 0 {
        match grammar_id {
            151 => {
                ...
                if error == 0 as i32 {
                    error =
                        encode_iso20_dc_MessageHeaderType(stream, &(*DC_CableCheckResType).Header);
                    if error == 0 as i32 {
                ...
                if error == 0 as i32 {
                    ...
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
                            stream,
                            6 as i32 as usize,
                            (*DC_CableCheckResType).ResponseCode as u32,
                        );
                        if error == 0 as i32 {
                            error = exi_basetypes_encoder_nbit_uint(
                                stream,
                ...
                if error == 0 as i32 {
                    ...
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
                            stream,
                            2 as i32 as usize,
                            (*DC_CableCheckResType).EVSEProcessing as u32,
                        );
                        if error == 0 as i32 {
                            error = exi_basetypes_encoder_nbit_uint(
                                stream,
...
unsafe extern "C" fn encode_iso20_dc_DC_PreChargeReqType(
    stream: &mut ExiBitstream,
    mut DC_PreChargeReqType: *const iso20_dc_DC_PreChargeReqType,
) -> i32 {
    ...
    while done == 0 {
        match grammar_id {
            154 => {
                ...
                if error == 0 as i32 {
                    error =
                        encode_iso20_dc_MessageHeaderType(stream, &(*DC_PreChargeReqType).Header);
                    if error == 0 as i32 {
                ...
                if error == 0 as i32 {
                    ...
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
                            stream,
                            2 as i32 as usize,
                            (*DC_PreChargeReqType).EVProcessing as u32,
                        );
                        if error == 0 as i32 {
                            error = exi_basetypes_encoder_nbit_uint(
                                stream,
            ...
            156 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*DC_PreChargeReqType).EVPresentVoltage,
                    );
                    if error == 0 as i32 {
            ...
            157 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*DC_PreChargeReqType).EVTargetVoltage,
                    );
                    if error == 0 as i32 {
                        grammar_id = 2 as i32;
                    }
...
unsafe extern "C" fn encode_iso20_dc_DC_PreChargeResType(
    stream: &mut ExiBitstream,
    mut DC_PreChargeResType: *const iso20_dc_DC_PreChargeResType,
) -> i32 {
    ...
    while done == 0 {
        match grammar_id {
            158 => {
                ...
                if error == 0 as i32 {
                    error =
                        encode_iso20_dc_MessageHeaderType(stream, &(*DC_PreChargeResType).Header);
                    if error == 0 as i32 {
                ...
                if error == 0 as i32 {
                    ...
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
                            stream,
                            6 as i32 as usize,
                            (*DC_PreChargeResType).ResponseCode as u32,
                        );
                        if error == 0 as i32 {
                            error = exi_basetypes_encoder_nbit_uint(
                                stream,
            ...
            160 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*DC_PreChargeResType).EVSEPresentVoltage,
                    );
                    if error == 0 as i32 {
                        grammar_id = 2 as i32;
                    }
...
unsafe extern "C" fn encode_iso20_dc_DC_WeldingDetectionReqType(
    stream: &mut ExiBitstream,
    mut DC_WeldingDetectionReqType: *const iso20_dc_DC_WeldingDetectionReqType,
) -> i32 {
    ...
    while done == 0 {
        match grammar_id {
            161 => {
                error = exi_basetypes_encoder_nbit_uint(stream, 1 as i32 as usize, 0 as i32 as u32);
                if error == 0 as i32 {
                    error = encode_iso20_dc_MessageHeaderType(
                        stream,
                        &(*DC_WeldingDetectionReqType).Header,
                    );
                    if error == 0 as i32 {
                ...
                if error == 0 as i32 {
                    ...
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
                            stream,
                            2 as i32 as usize,
                            (*DC_WeldingDetectionReqType).EVProcessing as u32,
                        );
                        if error == 0 as i32 {
                            error = exi_basetypes_encoder_nbit_uint(
                                stream,
...
unsafe extern "C" fn encode_iso20_dc_DC_WeldingDetectionResType(
    stream: &mut ExiBitstream,
    mut DC_WeldingDetectionResType: *const iso20_dc_DC_WeldingDetectionResType,
) -> i32 {
        ...
        match grammar_id {
            163 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_MessageHeaderType(
                        stream,
                        &(*DC_WeldingDetectionResType).Header,
                    );
                    if error == 0 as i32 {
                ...
                if error == 0 as i32 {
                    ...
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
                            stream,
                            6 as i32 as usize,
                            (*DC_WeldingDetectionResType).ResponseCode as u32,
                        );
                        if error == 0 as i32 {
                            error = exi_basetypes_encoder_nbit_uint(
                                stream,
            ...
            165 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*DC_WeldingDetectionResType).EVSEPresentVoltage,
                    );
                    if error == 0 as i32 {
                        grammar_id = 2 as i32;
                    }
...
unsafe extern "C" fn encode_iso20_dc_BPT_DC_CPDReqEnergyTransferModeType(
    stream: &mut ExiBitstream,
    mut BPT_DC_CPDReqEnergyTransferModeType: *const iso20_dc_BPT_DC_CPDReqEnergyTransferModeType,
) -> i32 {
        ...
        match grammar_id {
            166 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_DC_CPDReqEnergyTransferModeType).EVMaximumChargePower,
                    );
                    if error == 0 as i32 {
            ...
            167 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_DC_CPDReqEnergyTransferModeType).EVMinimumChargePower,
                    );
                    if error == 0 as i32 {
            ...
            172 => {
                if (*BPT_DC_CPDReqEnergyTransferModeType).TargetSOC_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
                        ...
                        if error == 0 as i32 {
                            error = exi_basetypes_encoder_nbit_uint(
                                stream,
                                7 as i32 as usize,
                                (*BPT_DC_CPDReqEnergyTransferModeType).TargetSOC as u32,
                            );
                            if error == 0 as i32 {
                                error = exi_basetypes_encoder_nbit_uint(
                                    stream,
                    ...
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_DC_CPDReqEnergyTransferModeType).EVMaximumDischargePower,
                        );
                        if error == 0 as i32 {
            ...
            174 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_DC_CPDReqEnergyTransferModeType).EVMinimumDischargePower,
                    );
                    if error == 0 as i32 {
...
unsafe extern "C" fn encode_iso20_dc_DC_ChargeParameterDiscoveryReqType(
    stream: &mut ExiBitstream,
    mut DC_ChargeParameterDiscoveryReqType: *const iso20_dc_DC_ChargeParameterDiscoveryReqType,
) -> i32 {
        ...
        match grammar_id {
            177 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_MessageHeaderType(
                        stream,
                        &(*DC_ChargeParameterDiscoveryReqType).Header,
                    );
                    if error == 0 as i32 {
            ...
            178 => {
                if (*DC_ChargeParameterDiscoveryReqType).BPT_DC_CPDReqEnergyTransferMode_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_BPT_DC_CPDReqEnergyTransferModeType(
                            stream,
                            &(*DC_ChargeParameterDiscoveryReqType).BPT_DC_CPDReqEnergyTransferMode,
                        );
                        if error == 0 as i32 {
                            grammar_id = 2 as i32;
                        }
                    ...
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 1 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_DC_CPDReqEnergyTransferModeType(
                            stream,
                            &(*DC_ChargeParameterDiscoveryReqType).DC_CPDReqEnergyTransferMode,
                        );
                        if error == 0 as i32 {
                            grammar_id = 2 as i32;
                        }
...
unsafe extern "C" fn encode_iso20_dc_BPT_DC_CPDResEnergyTransferModeType(
    stream: &mut ExiBitstream,
    mut BPT_DC_CPDResEnergyTransferModeType: *const iso20_dc_BPT_DC_CPDResEnergyTransferModeType,
) -> i32 {
        ...
        match grammar_id {
            179 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_DC_CPDResEnergyTransferModeType).EVSEMaximumChargePower,
                    );
                    if error == 0 as i32 {
            ...
            180 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_DC_CPDResEnergyTransferModeType).EVSEMinimumChargePower,
                    );
                    if error == 0 as i32 {
            ...
            181 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_DC_CPDResEnergyTransferModeType).EVSEMaximumChargeCurrent,
                    );
                    if error == 0 as i32 {
            ...
            182 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_DC_CPDResEnergyTransferModeType).EVSEMinimumChargeCurrent,
                    );
                    if error == 0 as i32 {
            ...
            183 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_DC_CPDResEnergyTransferModeType).EVSEMaximumVoltage,
                    );
                    if error == 0 as i32 {
            ...
            184 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_DC_CPDResEnergyTransferModeType).EVSEMinimumVoltage,
                    );
                    if error == 0 as i32 {
            ...
            185 => {
                if (*BPT_DC_CPDResEnergyTransferModeType).EVSEPowerRampLimitation_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_DC_CPDResEnergyTransferModeType).EVSEPowerRampLimitation,
                        );
                        if error == 0 as i32 {
                    ...
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_DC_CPDResEnergyTransferModeType).EVSEMaximumDischargePower,
                        );
                        if error == 0 as i32 {
            ...
            187 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_DC_CPDResEnergyTransferModeType).EVSEMinimumDischargePower,
                    );
                    if error == 0 as i32 {
            ...
            188 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_DC_CPDResEnergyTransferModeType).EVSEMaximumDischargeCurrent,
                    );
                    if error == 0 as i32 {
...
unsafe extern "C" fn encode_iso20_dc_DC_ChargeParameterDiscoveryResType(
    stream: &mut ExiBitstream,
    mut DC_ChargeParameterDiscoveryResType: *const iso20_dc_DC_ChargeParameterDiscoveryResType,
) -> i32 {
        ...
        match grammar_id {
            190 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_MessageHeaderType(
                        stream,
                        &(*DC_ChargeParameterDiscoveryResType).Header,
                    );
                    if error == 0 as i32 {
                ...
                if error == 0 as i32 {
                    ...
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
                            stream,
                            6 as i32 as usize,
                            (*DC_ChargeParameterDiscoveryResType).ResponseCode as u32,
                        );
                        if error == 0 as i32 {
                            error = exi_basetypes_encoder_nbit_uint(
                                stream,
            ...
            192 => {
                if (*DC_ChargeParameterDiscoveryResType).BPT_DC_CPDResEnergyTransferMode_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_BPT_DC_CPDResEnergyTransferModeType(
                            stream,
                            &(*DC_ChargeParameterDiscoveryResType).BPT_DC_CPDResEnergyTransferMode,
                        );
                        if error == 0 as i32 {
                            grammar_id = 2 as i32;
                        }
                    ...
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 1 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_DC_CPDResEnergyTransferModeType(
                            stream,
                            &(*DC_ChargeParameterDiscoveryResType).DC_CPDResEnergyTransferMode,
                        );
                        if error == 0 as i32 {
                            grammar_id = 2 as i32;
                        }
...
unsafe extern "C" fn encode_iso20_dc_BPT_Scheduled_DC_CLReqControlModeType(
    stream: &mut ExiBitstream,
    mut BPT_Scheduled_DC_CLReqControlModeType: *const iso20_dc_BPT_Scheduled_DC_CLReqControlModeType,
) -> i32 {
    ...
    while done == 0 {
        match grammar_id {
            193 => {
                if (*BPT_Scheduled_DC_CLReqControlModeType).EVTargetEnergyRequest_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Scheduled_DC_CLReqControlModeType).EVTargetEnergyRequest,
                        );
                        if error == 0 as i32 {
                            grammar_id = 194 as i32;
                        }
                    }
                } else if (*BPT_Scheduled_DC_CLReqControlModeType).EVMaximumEnergyRequest_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 1 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Scheduled_DC_CLReqControlModeType).EVMaximumEnergyRequest,
                        );
                        if error == 0 as i32 {
                            grammar_id = 195 as i32;
                        }
                    }
                } else if (*BPT_Scheduled_DC_CLReqControlModeType).EVMinimumEnergyRequest_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 2 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Scheduled_DC_CLReqControlModeType).EVMinimumEnergyRequest,
                        );
                        if error == 0 as i32 {
                    ...
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Scheduled_DC_CLReqControlModeType).EVTargetCurrent,
                        );
                        if error == 0 as i32 {
            ...
            194 => {
                if (*BPT_Scheduled_DC_CLReqControlModeType).EVMaximumEnergyRequest_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
            ...
            195 => {
                if (*BPT_Scheduled_DC_CLReqControlModeType).EVMinimumEnergyRequest_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
            ...
            197 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_Scheduled_DC_CLReqControlModeType).EVTargetVoltage,
                    );
                    if error == 0 as i32 {
            ...
            198 => {
                if (*BPT_Scheduled_DC_CLReqControlModeType).EVMaximumChargePower_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 4 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Scheduled_DC_CLReqControlModeType).EVMaximumChargePower,
                        );
                        if error == 0 as i32 {
                            grammar_id = 199 as i32;
                        }
                    }
                } else if (*BPT_Scheduled_DC_CLReqControlModeType).EVMinimumChargePower_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 4 as i32 as usize, 1 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Scheduled_DC_CLReqControlModeType).EVMinimumChargePower,
                        );
                        if error == 0 as i32 {
                            grammar_id = 200 as i32;
                        }
                    }
                } else if (*BPT_Scheduled_DC_CLReqControlModeType).EVMaximumChargeCurrent_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 4 as i32 as usize, 2 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Scheduled_DC_CLReqControlModeType).EVMaximumChargeCurrent,
                        );
                        if error == 0 as i32 {
                            grammar_id = 201 as i32;
                        }
                    }
                } else if (*BPT_Scheduled_DC_CLReqControlModeType).EVMaximumVoltage_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 4 as i32 as usize, 3 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Scheduled_DC_CLReqControlModeType).EVMaximumVoltage,
                        );
                        if error == 0 as i32 {
                            grammar_id = 202 as i32;
                        }
                    }
                } else if (*BPT_Scheduled_DC_CLReqControlModeType).EVMinimumVoltage_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 4 as i32 as usize, 4 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Scheduled_DC_CLReqControlModeType).EVMinimumVoltage,
                        );
                        if error == 0 as i32 {
                            grammar_id = 203 as i32;
                        }
                    }
                } else if (*BPT_Scheduled_DC_CLReqControlModeType).EVMaximumDischargePower_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 4 as i32 as usize, 5 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Scheduled_DC_CLReqControlModeType).EVMaximumDischargePower,
                        );
                        if error == 0 as i32 {
                            grammar_id = 204 as i32;
                        }
                    }
                } else if (*BPT_Scheduled_DC_CLReqControlModeType).EVMinimumDischargePower_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 4 as i32 as usize, 6 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Scheduled_DC_CLReqControlModeType).EVMinimumDischargePower,
                        );
                        if error == 0 as i32 {
                            grammar_id = 205 as i32;
                        }
                    }
                } else if (*BPT_Scheduled_DC_CLReqControlModeType)
                    .EVMaximumDischargeCurrent_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 4 as i32 as usize, 7 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Scheduled_DC_CLReqControlModeType).EVMaximumDischargeCurrent,
                        );
                        if error == 0 as i32 {
                            grammar_id = 2 as i32;
                        }
            ...
            199 => {
                if (*BPT_Scheduled_DC_CLReqControlModeType).EVMinimumChargePower_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 4 as i32 as usize, 0 as i32 as u32);
            ...
            200 => {
                if (*BPT_Scheduled_DC_CLReqControlModeType).EVMaximumChargeCurrent_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 0 as i32 as u32);
            ...
            201 => {
                if (*BPT_Scheduled_DC_CLReqControlModeType).EVMaximumVoltage_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
            ...
            202 => {
                if (*BPT_Scheduled_DC_CLReqControlModeType).EVMinimumVoltage_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
            ...
            203 => {
                if (*BPT_Scheduled_DC_CLReqControlModeType).EVMaximumDischargePower_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 0 as i32 as u32);
            ...
            204 => {
                if (*BPT_Scheduled_DC_CLReqControlModeType).EVMinimumDischargePower_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
            ...
            205 => {
                if (*BPT_Scheduled_DC_CLReqControlModeType).EVMaximumDischargeCurrent_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
...
unsafe extern "C" fn encode_iso20_dc_BPT_Scheduled_DC_CLResControlModeType(
    stream: &mut ExiBitstream,
    mut BPT_Scheduled_DC_CLResControlModeType: *const iso20_dc_BPT_Scheduled_DC_CLResControlModeType,
) -> i32 {
    ...
    while done == 0 {
        match grammar_id {
            206 => {
                if (*BPT_Scheduled_DC_CLResControlModeType).EVSEMaximumChargePower_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 4 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Scheduled_DC_CLResControlModeType).EVSEMaximumChargePower,
                        );
                        if error == 0 as i32 {
                            grammar_id = 207 as i32;
                        }
                    }
                } else if (*BPT_Scheduled_DC_CLResControlModeType).EVSEMinimumChargePower_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 4 as i32 as usize, 1 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Scheduled_DC_CLResControlModeType).EVSEMinimumChargePower,
                        );
                        if error == 0 as i32 {
                            grammar_id = 208 as i32;
                        }
                    }
                } else if (*BPT_Scheduled_DC_CLResControlModeType).EVSEMaximumChargeCurrent_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 4 as i32 as usize, 2 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Scheduled_DC_CLResControlModeType).EVSEMaximumChargeCurrent,
                        );
                        if error == 0 as i32 {
                            grammar_id = 209 as i32;
                        }
                    }
                } else if (*BPT_Scheduled_DC_CLResControlModeType).EVSEMaximumVoltage_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 4 as i32 as usize, 3 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Scheduled_DC_CLResControlModeType).EVSEMaximumVoltage,
                        );
                        if error == 0 as i32 {
                            grammar_id = 210 as i32;
                        }
                    }
                } else if (*BPT_Scheduled_DC_CLResControlModeType)
                    ...
                    == 1 as u32
                {
                    ...
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Scheduled_DC_CLResControlModeType).EVSEMaximumDischargePower,
                        );
                        if error == 0 as i32 {
                    ...
                    .EVSEMinimumDischargePower_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 4 as i32 as usize, 5 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Scheduled_DC_CLResControlModeType).EVSEMinimumDischargePower,
                        );
                        if error == 0 as i32 {
                    ...
                    .EVSEMaximumDischargeCurrent_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 4 as i32 as usize, 6 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Scheduled_DC_CLResControlModeType).EVSEMaximumDischargeCurrent,
                        );
                        if error == 0 as i32 {
                            grammar_id = 213 as i32;
                        }
                    }
                } else if (*BPT_Scheduled_DC_CLResControlModeType).EVSEMinimumVoltage_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 4 as i32 as usize, 7 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Scheduled_DC_CLResControlModeType).EVSEMinimumVoltage,
                        );
                        if error == 0 as i32 {
                            grammar_id = 2 as i32;
                        }
            ...
            207 => {
                if (*BPT_Scheduled_DC_CLResControlModeType).EVSEMinimumChargePower_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 4 as i32 as usize, 0 as i32 as u32);
            ...
            208 => {
                if (*BPT_Scheduled_DC_CLResControlModeType).EVSEMaximumChargeCurrent_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 0 as i32 as u32);
            ...
            209 => {
                if (*BPT_Scheduled_DC_CLResControlModeType).EVSEMaximumVoltage_isUsed() == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
            ...
            210 => {
                if (*BPT_Scheduled_DC_CLResControlModeType).EVSEMaximumDischargePower_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 0 as i32 as u32);
            ...
            211 => {
                if (*BPT_Scheduled_DC_CLResControlModeType).EVSEMinimumDischargePower_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 0 as i32 as u32);
            ...
            212 => {
                if (*BPT_Scheduled_DC_CLResControlModeType).EVSEMaximumDischargeCurrent_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
            ...
            213 => {
                if (*BPT_Scheduled_DC_CLResControlModeType).EVSEMinimumVoltage_isUsed() == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
...
unsafe extern "C" fn encode_iso20_dc_BPT_Dynamic_DC_CLReqControlModeType(
    stream: &mut ExiBitstream,
    mut BPT_Dynamic_DC_CLReqControlModeType: *const iso20_dc_BPT_Dynamic_DC_CLReqControlModeType,
) -> i32 {
    ...
    while done == 0 {
        match grammar_id {
            214 => {
                if (*BPT_Dynamic_DC_CLReqControlModeType).DepartureTime_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
                        ...
                        if error == 0 as i32 {
                            error = exi_basetypes_encoder_uint_32(
                                stream,
                                (*BPT_Dynamic_DC_CLReqControlModeType).DepartureTime,
                            );
                            if error == 0 as i32 {
                                error = exi_basetypes_encoder_nbit_uint(
                                    stream,
                    ...
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Dynamic_DC_CLReqControlModeType).EVTargetEnergyRequest,
                        );
                        if error == 0 as i32 {
            ...
            216 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_Dynamic_DC_CLReqControlModeType).EVMaximumEnergyRequest,
                    );
                    if error == 0 as i32 {
            ...
            217 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_Dynamic_DC_CLReqControlModeType).EVMinimumEnergyRequest,
                    );
                    if error == 0 as i32 {
            ...
            218 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_Dynamic_DC_CLReqControlModeType).EVMaximumChargePower,
                    );
                    if error == 0 as i32 {
            ...
            219 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_Dynamic_DC_CLReqControlModeType).EVMinimumChargePower,
                    );
                    if error == 0 as i32 {
            ...
            220 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_Dynamic_DC_CLReqControlModeType).EVMaximumChargeCurrent,
                    );
                    if error == 0 as i32 {
            ...
            221 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_Dynamic_DC_CLReqControlModeType).EVMaximumVoltage,
                    );
                    if error == 0 as i32 {
            ...
            222 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_Dynamic_DC_CLReqControlModeType).EVMinimumVoltage,
                    );
                    if error == 0 as i32 {
            ...
            223 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_Dynamic_DC_CLReqControlModeType).EVMaximumDischargePower,
                    );
                    if error == 0 as i32 {
            ...
            224 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_Dynamic_DC_CLReqControlModeType).EVMinimumDischargePower,
                    );
                    if error == 0 as i32 {
            ...
            225 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_Dynamic_DC_CLReqControlModeType).EVMaximumDischargeCurrent,
                    );
                    if error == 0 as i32 {
            ...
            226 => {
                if (*BPT_Dynamic_DC_CLReqControlModeType).EVMaximumV2XEnergyRequest_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Dynamic_DC_CLReqControlModeType).EVMaximumV2XEnergyRequest,
                        );
                        if error == 0 as i32 {
                            grammar_id = 227 as i32;
                        }
                    }
                } else if (*BPT_Dynamic_DC_CLReqControlModeType).EVMinimumV2XEnergyRequest_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 1 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Dynamic_DC_CLReqControlModeType).EVMinimumV2XEnergyRequest,
                        );
                        if error == 0 as i32 {
                            grammar_id = 2 as i32;
                        }
            ...
            227 => {
                if (*BPT_Dynamic_DC_CLReqControlModeType).EVMinimumV2XEnergyRequest_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
...
unsafe extern "C" fn encode_iso20_dc_DC_ChargeLoopReqType(
    stream: &mut ExiBitstream,
    mut DC_ChargeLoopReqType: *const iso20_dc_DC_ChargeLoopReqType,
) -> i32 {
    ...
    while done == 0 {
        match grammar_id {
            228 => {
                ...
                if error == 0 as i32 {
                    error =
                        encode_iso20_dc_MessageHeaderType(stream, &(*DC_ChargeLoopReqType).Header);
                    if error == 0 as i32 {
            ...
            229 => {
                if (*DC_ChargeLoopReqType).DisplayParameters_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_DisplayParametersType(
                            stream,
                            &(*DC_ChargeLoopReqType).DisplayParameters,
                        );
                        if error == 0 as i32 {
                    ...
                    if error == 0 as i32 {
                        ...
                        if error == 0 as i32 {
                            error = exi_basetypes_encoder_bool(
                                stream,
                                (*DC_ChargeLoopReqType).MeterInfoRequested,
                            );
                            if error == 0 as i32 {
                                error = exi_basetypes_encoder_nbit_uint(
                                    stream,
            ...
            231 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*DC_ChargeLoopReqType).EVPresentVoltage,
                    );
                    if error == 0 as i32 {
            ...
            232 => {
                if (*DC_ChargeLoopReqType).BPT_Dynamic_DC_CLReqControlMode_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_BPT_Dynamic_DC_CLReqControlModeType(
                            stream,
                            &(*DC_ChargeLoopReqType).BPT_Dynamic_DC_CLReqControlMode,
                        );
                        if error == 0 as i32 {
                            grammar_id = 2 as i32;
                        }
                    }
                } else if (*DC_ChargeLoopReqType).BPT_Scheduled_DC_CLReqControlMode_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 1 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_BPT_Scheduled_DC_CLReqControlModeType(
                            stream,
                            &(*DC_ChargeLoopReqType).BPT_Scheduled_DC_CLReqControlMode,
                        );
                        if error == 0 as i32 {
                            grammar_id = 2 as i32;
                        }
                    }
                } else if (*DC_ChargeLoopReqType).CLReqControlMode_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 2 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_CLReqControlModeType(
                            stream,
                            &(*DC_ChargeLoopReqType).CLReqControlMode,
                        );
                        if error == 0 as i32 {
                            grammar_id = 2 as i32;
                        }
                    }
                } else if (*DC_ChargeLoopReqType).Dynamic_DC_CLReqControlMode_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 3 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_Dynamic_DC_CLReqControlModeType(
                            stream,
                            &(*DC_ChargeLoopReqType).Dynamic_DC_CLReqControlMode,
                        );
                        if error == 0 as i32 {
                            grammar_id = 2 as i32;
                        }
                    ...
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 4 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_Scheduled_DC_CLReqControlModeType(
                            stream,
                            &(*DC_ChargeLoopReqType).Scheduled_DC_CLReqControlMode,
                        );
                        if error == 0 as i32 {
                            grammar_id = 2 as i32;
                        }
...
unsafe extern "C" fn encode_iso20_dc_BPT_Dynamic_DC_CLResControlModeType(
    stream: &mut ExiBitstream,
    mut BPT_Dynamic_DC_CLResControlModeType: *const iso20_dc_BPT_Dynamic_DC_CLResControlModeType,
) -> i32 {
    ...
    while done == 0 {
        match grammar_id {
            233 => {
                if (*BPT_Dynamic_DC_CLResControlModeType).DepartureTime_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
                        ...
                        if error == 0 as i32 {
                            error = exi_basetypes_encoder_uint_32(
                                stream,
                                (*BPT_Dynamic_DC_CLResControlModeType).DepartureTime,
                            );
                            if error == 0 as i32 {
                                error = exi_basetypes_encoder_nbit_uint(
                                    stream,
                ...
                } else if (*BPT_Dynamic_DC_CLResControlModeType).MinimumSOC_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 1 as i32 as u32);
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
                        ...
                        if error == 0 as i32 {
                            error = exi_basetypes_encoder_nbit_uint(
                                stream,
                                7 as i32 as usize,
                                (*BPT_Dynamic_DC_CLResControlModeType).MinimumSOC as u32,
                            );
                            if error == 0 as i32 {
                                error = exi_basetypes_encoder_nbit_uint(
                                    stream,
                ...
                } else if (*BPT_Dynamic_DC_CLResControlModeType).TargetSOC_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 2 as i32 as u32);
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
                        ...
                        if error == 0 as i32 {
                            error = exi_basetypes_encoder_nbit_uint(
                                stream,
                                7 as i32 as usize,
                                (*BPT_Dynamic_DC_CLResControlModeType).TargetSOC as u32,
                            );
                            if error == 0 as i32 {
                                error = exi_basetypes_encoder_nbit_uint(
                                    stream,
                ...
                } else if (*BPT_Dynamic_DC_CLResControlModeType).AckMaxDelay_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 3 as i32 as u32);
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
                        ...
                        if error == 0 as i32 {
                            error = exi_basetypes_encoder_uint_16(
                                stream,
                                (*BPT_Dynamic_DC_CLResControlModeType).AckMaxDelay,
                            );
                            if error == 0 as i32 {
                                error = exi_basetypes_encoder_nbit_uint(
                                    stream,
                    ...
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*BPT_Dynamic_DC_CLResControlModeType).EVSEMaximumChargePower,
                        );
                        if error == 0 as i32 {
            ...
            234 => {
                if (*BPT_Dynamic_DC_CLResControlModeType).MinimumSOC_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
            ...
            235 => {
                if (*BPT_Dynamic_DC_CLResControlModeType).TargetSOC_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
            ...
            236 => {
                if (*BPT_Dynamic_DC_CLResControlModeType).AckMaxDelay_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
            ...
            238 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_Dynamic_DC_CLResControlModeType).EVSEMinimumChargePower,
                    );
                    if error == 0 as i32 {
            ...
            239 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_Dynamic_DC_CLResControlModeType).EVSEMaximumChargeCurrent,
                    );
                    if error == 0 as i32 {
            ...
            240 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_Dynamic_DC_CLResControlModeType).EVSEMaximumVoltage,
                    );
                    if error == 0 as i32 {
            ...
            241 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_Dynamic_DC_CLResControlModeType).EVSEMaximumDischargePower,
                    );
                    if error == 0 as i32 {
            ...
            242 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_Dynamic_DC_CLResControlModeType).EVSEMinimumDischargePower,
                    );
                    if error == 0 as i32 {
            ...
            243 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_Dynamic_DC_CLResControlModeType).EVSEMaximumDischargeCurrent,
                    );
                    if error == 0 as i32 {
            ...
            244 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*BPT_Dynamic_DC_CLResControlModeType).EVSEMinimumVoltage,
                    );
                    if error == 0 as i32 {
                        grammar_id = 2 as i32;
                    }
...
unsafe extern "C" fn encode_iso20_dc_DC_ChargeLoopResType(
    stream: &mut ExiBitstream,
    mut DC_ChargeLoopResType: *const iso20_dc_DC_ChargeLoopResType,
) -> i32 {
    ...
    while done == 0 {
        match grammar_id {
            245 => {
                ...
                if error == 0 as i32 {
                    error =
                        encode_iso20_dc_MessageHeaderType(stream, &(*DC_ChargeLoopResType).Header);
                    if error == 0 as i32 {
                ...
                if error == 0 as i32 {
                    ...
                    if error == 0 as i32 {
                        error = exi_basetypes_encoder_nbit_uint(
                            stream,
                            6 as i32 as usize,
                            (*DC_ChargeLoopResType).ResponseCode as u32,
                        );
                        if error == 0 as i32 {
                            error = exi_basetypes_encoder_nbit_uint(
                                stream,
            ...
            247 => {
                if (*DC_ChargeLoopResType).EVSEStatus_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_EVSEStatusType(
                            stream,
                            &(*DC_ChargeLoopResType).EVSEStatus,
                        );
                        if error == 0 as i32 {
                            grammar_id = 248 as i32;
                        }
                    }
                } else if (*DC_ChargeLoopResType).MeterInfo_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 1 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_MeterInfoType(
                            stream,
                            &(*DC_ChargeLoopResType).MeterInfo,
                        );
                        if error == 0 as i32 {
                            grammar_id = 249 as i32;
                        }
                    }
                } else if (*DC_ChargeLoopResType).Receipt_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 2 as i32 as u32);
                    if error == 0 as i32 {
                        error =
                            encode_iso20_dc_ReceiptType(stream, &(*DC_ChargeLoopResType).Receipt);
                        if error == 0 as i32 {
                    ...
                    if error == 0 as i32 {
                        error = encode_iso20_dc_RationalNumberType(
                            stream,
                            &(*DC_ChargeLoopResType).EVSEPresentCurrent,
                        );
                        if error == 0 as i32 {
            ...
            248 => {
                if (*DC_ChargeLoopResType).MeterInfo_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_MeterInfoType(
            ...
            249 => {
                if (*DC_ChargeLoopResType).Receipt_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error =
            ...
            251 => {
                ...
                if error == 0 as i32 {
                    error = encode_iso20_dc_RationalNumberType(
                        stream,
                        &(*DC_ChargeLoopResType).EVSEPresentVoltage,
                    );
                    if error == 0 as i32 {
            ...
            255 => {
                if (*DC_ChargeLoopResType).BPT_Dynamic_DC_CLResControlMode_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 0 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_BPT_Dynamic_DC_CLResControlModeType(
                            stream,
                            &(*DC_ChargeLoopResType).BPT_Dynamic_DC_CLResControlMode,
                        );
                        if error == 0 as i32 {
                            grammar_id = 2 as i32;
                        }
                    }
                } else if (*DC_ChargeLoopResType).BPT_Scheduled_DC_CLResControlMode_isUsed()
                    == 1 as u32
                {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 1 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_BPT_Scheduled_DC_CLResControlModeType(
                            stream,
                            &(*DC_ChargeLoopResType).BPT_Scheduled_DC_CLResControlMode,
                        );
                        if error == 0 as i32 {
                            grammar_id = 2 as i32;
                        }
                    }
                } else if (*DC_ChargeLoopResType).CLResControlMode_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 2 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_CLResControlModeType(
                            stream,
                            &(*DC_ChargeLoopResType).CLResControlMode,
                        );
                        if error == 0 as i32 {
                            grammar_id = 2 as i32;
                        }
                    }
                } else if (*DC_ChargeLoopResType).Dynamic_DC_CLResControlMode_isUsed() == 1 as u32 {
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 3 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_Dynamic_DC_CLResControlModeType(
                            stream,
                            &(*DC_ChargeLoopResType).Dynamic_DC_CLResControlMode,
                        );
                        if error == 0 as i32 {
                            grammar_id = 2 as i32;
                        }
                    ...
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 3 as i32 as usize, 4 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_Scheduled_DC_CLResControlModeType(
                            stream,
                            &(*DC_ChargeLoopResType).Scheduled_DC_CLResControlMode,
                        );
                        if error == 0 as i32 {
                            grammar_id = 2 as i32;
                        }
...
unsafe extern "C" fn encode_iso20_dc_ManifestType(
    stream: &mut ExiBitstream,
    mut ManifestType: *const iso20_dc_ManifestType,
) -> i32 {
...
unsafe extern "C" fn encode_iso20_dc_SignaturePropertiesType(
    stream: &mut ExiBitstream,
    mut SignaturePropertiesType: *const iso20_dc_SignaturePropertiesType,
) -> i32 {
            ...
            260 => {
                if (*SignaturePropertiesType).Id_isUsed() == 1 as u32 {
                    ...
                    error =
                        exi_basetypes_encoder_nbit_uint(stream, 2 as i32 as usize, 1 as i32 as u32);
                    if error == 0 as i32 {
                        error = encode_iso20_dc_SignaturePropertyType(
                            stream,
...
pub unsafe extern "C" fn encode_iso20_dc_exiDocument(
    stream: &mut ExiBitstream,
    mut exiDoc: *mut iso20_dc_exiDocument,
) -> i32 {
    let mut error: i32 = exi_header_write(stream);
    if error == 0 as i32 {
        if (*exiDoc).BPT_DC_CPDReqEnergyTransferMode_isUsed() as i32 == 1 as i32 {
        ...
        } else if (*exiDoc).BPT_DC_CPDResEnergyTransferMode_isUsed() as i32 == 1 as i32 {
        ...
        } else if (*exiDoc).BPT_Dynamic_DC_CLReqControlMode_isUsed() as i32 == 1 as i32 {
        ...
        } else if (*exiDoc).BPT_Dynamic_DC_CLResControlMode_isUsed() as i32 == 1 as i32 {
        ...
        } else if (*exiDoc).BPT_Scheduled_DC_CLReqControlMode_isUsed() as i32 == 1 as i32 {
        ...
        } else if (*exiDoc).BPT_Scheduled_DC_CLResControlMode_isUsed() as i32 == 1 as i32 {
        ...
        } else if (*exiDoc).DC_CPDReqEnergyTransferMode_isUsed() as i32 == 1 as i32 {
        ...
        } else if (*exiDoc).DC_CPDResEnergyTransferMode_isUsed() as i32 == 1 as i32 {
            ...
            if error == 0 as i32 {
                error = encode_iso20_dc_DSAKeyValueType(
                    stream,
        ...
        } else if (*exiDoc).Dynamic_DC_CLReqControlMode_isUsed() as i32 == 1 as i32 {
        ...
        } else if (*exiDoc).Dynamic_DC_CLResControlMode_isUsed() as i32 == 1 as i32 {
            ...
            if error == 0 as i32 {
                error = encode_iso20_dc_KeyInfoType(stream, &mut (*exiDoc).c2rust_unnamed.KeyInfo);
            }
            ...
            if error == 0 as i32 {
                error =
                    encode_iso20_dc_KeyValueType(stream, &mut (*exiDoc).c2rust_unnamed.KeyValue);
            }
            ...
            if error == 0 as i32 {
                error =
                    encode_iso20_dc_ManifestType(stream, &mut (*exiDoc).c2rust_unnamed.Manifest);
            }
            ...
            if error == 0 as i32 {
                error = encode_iso20_dc_ObjectType(stream, &mut (*exiDoc).c2rust_unnamed.Object);
            }
            ...
            if error == 0 as i32 {
                error = encode_iso20_dc_PGPDataType(stream, &mut (*exiDoc).c2rust_unnamed.PGPData);
            }
            ...
            if error == 0 as i32 {
                error = encode_iso20_dc_RSAKeyValueType(
                    stream,
            ...
            if error == 0 as i32 {
                error =
                    encode_iso20_dc_ReferenceType(stream, &mut (*exiDoc).c2rust_unnamed.Reference);
            }
            ...
            if error == 0 as i32 {
                error =
                    encode_iso20_dc_SPKIDataType(stream, &mut (*exiDoc).c2rust_unnamed.SPKIData);
            }
        } else if (*exiDoc).Scheduled_DC_CLReqControlMode_isUsed() as i32 == 1 as i32 {
        ...
        } else if (*exiDoc).Scheduled_DC_CLResControlMode_isUsed() as i32 == 1 as i32 {
            ...
            if error == 0 as i32 {
                error = encode_iso20_dc_SignaturePropertiesType(
                    stream,
            ...
            if error == 0 as i32 {
                error =
                    encode_iso20_dc_SignatureType(stream, &mut (*exiDoc).c2rust_unnamed.Signature);
            }
            ...
            if error == 0 as i32 {
                error = encode_iso20_dc_SignedInfoType(
                    stream,
            ...
            if error == 0 as i32 {
                error =
                    encode_iso20_dc_TransformType(stream, &mut (*exiDoc).c2rust_unnamed.Transform);
            }
            ...
            if error == 0 as i32 {
                error =
                    encode_iso20_dc_X509DataType(stream, &mut (*exiDoc).c2rust_unnamed.X509Data);
            }
        } else {
            error = -(70 as i32);
        }
...
pub unsafe extern "C" fn encode_iso20_dc_exiFragment(
    stream: &mut ExiBitstream,
    ...
    if error == 0 as i32 {
        if 0 as i32 == 1 as i32 {
            error = -(299 as i32);
        } else if (*exiFrag).DC_ChargeParameterDiscoveryRes_isUsed() as i32 == 1 as i32 {
            error = exi_basetypes_encoder_nbit_uint(stream, 8 as i32 as usize, 26 as i32 as u32);
            if error == 0 as i32 {
                error = encode_iso20_dc_DC_ChargeParameterDiscoveryResType(
                    stream,
            ...
            error = exi_basetypes_encoder_nbit_uint(stream, 8 as i32 as usize, 129 as i32 as u32);
            if error == 0 as i32 {
                error = encode_iso20_dc_SignedInfoType(
                    stream,
        ...
        if error == 0 as i32 {
            error = exi_basetypes_encoder_nbit_uint(stream, 8 as i32 as usize, 150 as i32 as u32);
        }
    }
    return error;
}

pub unsafe extern "C" fn encode_iso20_dc_xmldsigFragment(
    stream: &mut ExiBitstream,
    ...
    if error == 0 as i32 {
        if (*xmldsigFrag).CanonicalizationMethod_isUsed() as i32 == 1 as i32 {
            ...
            if error == 0 as i32 {
                error =
                    encode_iso20_dc_KeyInfoType(stream, &mut (*xmldsigFrag).c2rust_unnamed.KeyInfo);
            }
        } else if (*xmldsigFrag).KeyValue_isUsed() as i32 == 1 as i32 {
            error = exi_basetypes_encoder_nbit_uint(stream, 6 as i32 as usize, 10 as i32 as u32);
            if error == 0 as i32 {
                error = encode_iso20_dc_KeyValueType(
                    stream,
            ...
            error = exi_basetypes_encoder_nbit_uint(stream, 6 as i32 as usize, 11 as i32 as u32);
            if error == 0 as i32 {
                error = encode_iso20_dc_ManifestType(
                    stream,
            ...
            if error == 0 as i32 {
                error =
                    encode_iso20_dc_ObjectType(stream, &mut (*xmldsigFrag).c2rust_unnamed.Object);
            }
        } else if (*xmldsigFrag).PGPData_isUsed() as i32 == 1 as i32 {
            error = exi_basetypes_encoder_nbit_uint(stream, 6 as i32 as usize, 16 as i32 as u32);
            if error == 0 as i32 {
                error =
                    encode_iso20_dc_PGPDataType(stream, &mut (*xmldsigFrag).c2rust_unnamed.PGPData);
            }
            ...
            error = exi_basetypes_encoder_nbit_uint(stream, 6 as i32 as usize, 24 as i32 as u32);
            if error == 0 as i32 {
                error = encode_iso20_dc_SPKIDataType(
                    stream,
            ...
            if error == 0 as i32 {
                error = encode_iso20_dc_SignatureType(
                    stream,
            ...
            error = exi_basetypes_encoder_nbit_uint(stream, 6 as i32 as usize, 33 as i32 as u32);
            if error == 0 as i32 {
                error = encode_iso20_dc_TransformType(
                    stream,
            ...
            error = exi_basetypes_encoder_nbit_uint(stream, 6 as i32 as usize, 37 as i32 as u32);
            if error == 0 as i32 {
                error = encode_iso20_dc_X509DataType(
                    stream,
