                    ...
                    match event_code {
                        0 => {
                            exi_basetypes_decoder_uint_16(
                                stream,
                                &mut ((*message).algorithm.len() as u16),
                            )?;
                            if error == 0 as i32 {
                                if (*message).algorithm.len() >= 2 {
                                    (*message).algorithm.len =
                                        ((*message).algorithm.len() as i32 - 2 as i32)
                                            as usize;
                                    ...
                                    if error == 0 as i32 {
                                            ...
                                            >= 2 as i32
                                        {
                                            ...
                                            exi_basetypes_decoder_characters(
                                                ...
                                                &mut (*x509_issuer_serial).x509_issuer_name,
                                                (64 as i32 + 1 as i32) as usize,
                                            )?;
                                        } else {
                                            return Err(ExiError::StringValuesNotSupported);
                    ...
                    match event_code {
                        0 => {
                            decode_exi_type_uint32(
                                stream,
                                &mut (*message).duration.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            decode_exi_type_hex_binary(
                                stream,
                                &mut (*message).exponent.len(),
                                &mut (*message).exponent,
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                    ...
                    match event_code {
                        0 => {
                            if ((*message).cost.len() as i32) < 3 as i32 {
                                ...
                                (*message).cost.len() =
                                    ((*message).cost.len()).wrapping_add(1);
                                if let Some(cost) =
                                    (*message).cost.get_mut(fresh0 as usize)
                                {
                    ...
                    match event_code {
                        0 => {
                            if ((*message).cost.len() as i32) < 3 as i32 {
                                ...
                                (*message).cost.len() = ((*message).cost.len()).wrapping_add(1);
                    ...
                    match event_code {
                        ...
                        1 => {
                            decode_iso2_interval(
                                stream,
                                &mut (*message).TimeInterval.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 37 as i32;
                            }
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            decode_iso2_relative_time_interval(
                                stream,
                                &mut (*message).RelativeTimeInterval.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
            ...
            39 => {
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            ...
                            if error == 0 as i32 {
                                if event_code == 0 as i32 as u32 {
                                    ...
                                    if error == 0 as i32 {
                                        (*message).EPriceLevel = Some(value as u8);
                                    }
                                } else {
                                    return Err(ExiError::UnsupportedSubEvent);
                                }
                        ...
                        1 => {
                            if ((*message).ConsumptionCost.len() as i32) < 3 as i32 {
                                let fresh2 = (*message).ConsumptionCost.len();
                                (*message).ConsumptionCost.len() =
                                    ((*message).ConsumptionCost.len()).wrapping_add(1);
            ...
            40 => {
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            if ((*message).ConsumptionCost.len() as i32) < 3 as i32 {
                                let fresh3 = (*message).ConsumptionCost.len();
                                (*message).ConsumptionCost.len() =
                                    ((*message).ConsumptionCost.len()).wrapping_add(1);
                                if let Some(consumption_cost) = (*SalesTariffEntryType)
                                    .ConsumptionCost
            ...
            41 => {
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            if ((*message).ConsumptionCost.len() as i32) < 3 as i32 {
                                let fresh4 = (*message).ConsumptionCost.len();
                                (*message).ConsumptionCost.len() =
                                    ((*message).ConsumptionCost.len()).wrapping_add(1);
                                if let Some(consumption_cost) = (*SalesTariffEntryType)
                                    .ConsumptionCost
            ...
            42 => {
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            if ((*message).ConsumptionCost.len() as i32) < 3 as i32 {
                                let fresh5 = (*message).ConsumptionCost.len();
                                (*message).ConsumptionCost.len() =
                                    ((*message).ConsumptionCost.len()).wrapping_add(1);
                                if let Some(consumption_cost) = (*SalesTariffEntryType)
                                    .ConsumptionCost
                    ...
                    match event_code {
                        0 => {
                            ...
                            if error == 0 as i32 {
                                if event_code == 0 as i32 as u32 {
                                    ...
                                    if error == 0 as i32 {
                                        (*message).boolValue = Some(value as i32);
                                    }
                                } else {
                                    return Err(ExiError::UnsupportedSubEvent);
                                }
                        ...
                        2 => {
                            decode_exi_type_integer16(
                                stream,
                                &mut (*message).shortValue.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                        ...
                        3 => {
                            decode_exi_type_integer32(
                                stream,
                                &mut (*message).intValue.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                        ...
                        4 => {
                            decode_iso2_physical_value(
                                stream,
                                &mut (*message).physicalValue.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                        ...
                        5 => {
                            ...
                            if error == 0 as i32 {
                                if event_code == 0 as i32 as u32 {
                                    exi_basetypes_decoder_uint_16(
                                        stream,
                                        &mut ((*message).stringValue.unwrap().len() as u16),
                                    )?;
                                    if error == 0 as i32 {
                                        if (*message).stringValue.unwrap().len() >= 2 {
                                            (*message).stringValue.unwrap().len -= 2;
                                            exi_basetypes_decoder_characters(
                                                stream,
                                                (*message).stringValue.unwrap().len() as usize,
                                                &mut (*message).stringValue.unwrap(),
                                                (64 as i32 + 1 as i32) as usize,
                                            )?;
                                        } else {
                                            return Err(ExiError::StringValuesNotSupported);
                ...
                if error == 0 as i32 {
                    match event_code {
                        ...
                        2 => {
                            exi_basetypes_decoder_uint_16(
                                stream,
                                &mut ((*message).uri.unwrap().len() as u16),
                            )?;
                            if error == 0 as i32 {
                        ...
                        0 => {
                            ...
                            if error == 0 as i32 {
                                if event_code == 0 as i32 as u32 {
                                    exi_basetypes_decoder_uint_16(
                                        stream,
                                        &mut ((*message).sales_tariff_description.unwrap().len
                                            as u16),
                                    )?;
                                    if error == 0 as i32 {
                                        if (*message).sales_tariff_description.unwrap().len
                                            as i32
                                            >= 2 as i32
                                        {
                                            (*sales_tariff)
                    ...
                    match event_code {
                        0 => {
                            decode_iso2_X509IssuerSerial(
                                stream,
                                &mut (*X509DataType).x509_issuer_serial.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                        ...
                        1 => {
                            decode_exi_type_hex_binary(
                                stream,
                                &mut (*X509DataType).x509_ski.unwrap().len(),
                                &mut (*X509DataType).x509_ski.unwrap(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                        ...
                        2 => {
                            exi_basetypes_decoder_nbit_uint(
                                stream,
                                1 as i32 as usize,
                                &mut event_code,x509_x509_issuer_serial
                            )?;
                            if error == 0 as i32 {
                                if event_code == 0 as i32 as u32 {
                                    exi_basetypes_decoder_uint_16(
                                            ...
                                            >= 2 as i32
                                        {
                                            ...
                                            exi_basetypes_decoder_characters(
                                                ...
                                                (*X509DataType).X509SubjectName.unwrap().len
                                                    as usize,
                                                &mut (*X509DataType).X509SubjectName.unwrap(),
                                            )?;
                                        } else {
                                            return Err(ExiError::StringValuesNotSupported);
                                        }
                        ...
                        3 => {
                            decode_exi_type_hex_binary(
                                ...
                                &mut (*X509DataType).X509Certificate.unwrap(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                        ...
                        4 => {
                            decode_exi_type_hex_binary(
                                ...
                                &mut (*X509DataType).X509CRL.unwrap(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
        ...
        match grammar_id {
            65 => {
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            let pgp_data = match &mut (*message).PGPComponent {
                        ...
                        1 => {
                            ...
                            decode_exi_type_hex_binary(
                                ...
                                &mut pgp_data.PGPKeyPacket.unwrap(),
                            )?;
                            if error == 0 as i32 {
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            decode_exi_type_hex_binary(
                                stream,
                                &mut (*message).SPKISexp.len(),
                                &mut (*message).SPKISexp,
        ...
        match grammar_id {
                    ...
                    match event_code {
                        ...
                        1 => {
                            decode_iso2_canonicalization_method(
                                stream,
                                &mut (*message).CanonicalizationMethod,
                            )?;
                            if error == 0 as i32 {
            ...
            74 => {
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            decode_iso2_signature_method(stream, &mut (*message).SignatureMethod)?;
                            if error == 0 as i32 {
            ...
            75 => {
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            if (*message).ReferenceLen < 4 {
                                let fresh14 = (*message).ReferenceLen;
                                if let Some(reference) =
                                    (*message).Reference.get_mut(fresh14 as usize)
                                {
                                    decode_iso2_Reference(stream, reference)?;
                                    (*message).ReferenceLen += 1;
                                } else {
                                    return Err(ExiError::ArrayOutOfBounds);
                                }
                            } else {
            ...
            76 => {
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            if ((*message).ReferenceLen as i32) < 4 as i32 {
                                let fresh15 = (*message).ReferenceLen;
                                (*message).ReferenceLen = ((*message).ReferenceLen).wrapping_add(1);
                                if let Some(reference) =
                                    (*message).Reference.get_mut(fresh15 as usize)
                                {
                                    decode_iso2_Reference(stream, reference)?;
                                } else {
                                    return Err(ExiError::ArrayOutOfBounds);
                    ...
                    match event_code {
                        0 => {
                            decode_iso2_sales_tariff(
                                stream,
                                &mut (*message).SalesTariff.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            decode_exi_type_integer16(
                                stream,
                                &mut (*message).ParameterSetID.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                        ...
                        0 => {
                            ...
                            if error == 0 as i32 {
                                if event_code == 0 as i32 as u32 {
                                    exi_basetypes_decoder_uint_16(
                                        stream,
                                        &mut ((*message).ServiceScope.unwrap().len() as u16),
                                    )?;
                                    if error == 0 as i32 {
                                        if (*message).ServiceScope.unwrap().len() >= 2 {
                                            (*message).ServiceScope.unwrap().len -= 2;
                                            exi_basetypes_decoder_characters(
                                                stream,
                                                (*message).ServiceScope.unwrap().len(),
                    ...
                    match event_code {
                        ...
                        1 => {
                            ...
                            if error == 0 as i32 {
                                if event_code == 0 as i32 as u32 {
                                    exi_basetypes_decoder_uint_16(
                                        stream,
                                        &mut ((*message).KeyName.unwrap().len() as u16),
                                    )?;
                                    if error == 0 as i32 {
                                        if (*message).KeyName.unwrap().len() >= 2 {
                                            (*message).KeyName.unwrap().len -= 2;
                                            exi_basetypes_decoder_characters(
                                                stream,
                                                (*message).KeyName.unwrap().len() as usize,
                                                &mut (*message).KeyName.unwrap(),
                                                (64 as i32 + 1 as i32) as usize,
                                            )?;
                                        } else {
                                            return Err(ExiError::StringValuesNotSupported);
                        ...
                        2 => {
                            decode_iso2_KeyValue(
                                stream,
                                &mut (*message).KeyValue.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                        ...
                        3 => {
                            decode_iso2_RetrievalMethod(
                                stream,
                                &mut (*message).RetrievalMethod.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                        ...
                        4 => {
                            decode_iso2_x509_data(
                                stream,
                                &mut (*message).X509Data.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                        ...
                        5 => {
                            decode_iso2_pgpdata(stream, &mut (*message).PGPData.unwrap())?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                        }
                        6 => {
                            decode_iso2_spkidata(
                                stream,
                                &mut (*message).SPKIData.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                        ...
                        7 => {
                            ...
                            if error == 0 as i32 {
                                if event_code == 0 as i32 as u32 {
                                    let mgmt_data = (*message).MgmtData.as_mut().unwrap();
                                    exi_basetypes_decoder_uint_16(
                                        stream,
                        ...
                        6 => {
                            ...
                            if error == 0 as i32 {
                                if event_code == 0 as i32 as u32 {
                                    exi_basetypes_decoder_uint_16(
                                        stream,
                                        &mut ((*message).MgmtData.unwrap().len() as u16),
                                    )?;
                                    if error == 0 as i32 {
                                        if (*message).MgmtData.unwrap().len() >= 2 {
                                            (*message).MgmtData.unwrap().len -= 2;
                                            exi_basetypes_decoder_characters(
                                                stream,
                                                (*message).MgmtData.unwrap().len() as usize,
                                                &mut (*message).MgmtData.unwrap(),
                                                (64 as i32 + 1 as i32) as usize,
                                            )?;
                                        } else {
                                            return Err(ExiError::StringValuesNotSupported);
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            exi_basetypes_decoder_uint_16(
                                stream,
                                &mut ((*message).Encoding.unwrap().len() as u16),
                            )?;
                            if error == 0 as i32 {
                                if (*message).Encoding.unwrap().len() >= 2 {
                                    (*message).Encoding.unwrap().len -= 2;
                                    exi_basetypes_decoder_characters(
                                        stream,
                                        (*message).Encoding.unwrap().len(),
                                        &mut (*message).Encoding.unwrap(),
                                        65,
                                    )?;
                                } else {
                                    return Err(ExiError::StringValuesNotSupported);
                        ...
                        1 => {
                            exi_basetypes_decoder_uint_16(
                                stream,
                                &mut ((*message).id.as_mut().unwrap().len() as u16),
                            )?;
                            if error == 0 as i32 {
                                if (*message).id.as_ref().unwrap().len() >= 2 {
                                    (*message).id.as_mut().unwrap().len -= 2;
                                    exi_basetypes_decoder_characters(
                                        stream,
                                        (*message).id.as_ref().unwrap().len(),
                        ...
                        2 => {
                            exi_basetypes_decoder_uint_16(
                                stream,
                                &mut ((*message).MimeType.unwrap().len() as u16),
                            )?;
                            if error == 0 as i32 {
                                if (*message).MimeType.unwrap().len() >= 2 {
                                    (*message).MimeType.unwrap().len -= 2;
                                    exi_basetypes_decoder_characters(
                                        stream,
                                        (*message).MimeType.unwrap().len(),
                                        &mut (*message).MimeType.unwrap(),
                                        65,
                                    )?;
                                } else {
                                    return Err(ExiError::StringValuesNotSupported);
                    ...
                    match event_code {
                        0 => {
                            decode_iso2_SubCertificates(
                                stream,
                                &mut (*message).SubCertificates.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                        ...
                        0 => {
                            ...
                            if error == 0 as i32 {
                                if event_code == 0 as i32 as u32 {
                                    ...
                                    if error == 0 as i32 {
                                        (*message).FaultCode = value as Iso2FaultCodeType;
                                    }
                                } else {
                                    return Err(ExiError::UnsupportedSubEvent);
                                }
                        ...
                        0 => {
                            ...
                            if error == 0 as i32 {
                                if event_code == 0 as i32 as u32 {
                                    exi_basetypes_decoder_uint_16(
                                        stream,
                                        &mut ((*message).FaultMsg.unwrap().len() as u16),
                                    )?;
                                    if error == 0 as i32 {
                                        if (*message).FaultMsg.unwrap().len() >= 2 {
                                            (*message).FaultMsg.unwrap().len -= 2;
                                            exi_basetypes_decoder_characters(
                                                stream,
                                                (*message).FaultMsg.unwrap().len(),
                                                &mut (*message).FaultMsg.unwrap(),
                                                65,
                                            )?;
                                        } else {
                                            return Err(ExiError::StringValuesNotSupported);
        ...
        match grammar_id {
            ...
            123 => {
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            decode_iso2_signature_value(stream, &mut (*message).SignatureValue)?;
                            if error == 0 as i32 {
            ...
            124 => {
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            decode_iso2_KeyInfo(stream, &mut (*message).KeyInfo.unwrap().clone())?;
                            if error == 0 as i32 {
                                grammar_id = 126 as i32;
                            }
                        }
                        1 => {
                            decode_iso2_object(stream, &mut (*message).Object.unwrap())?;
                            if error == 0 as i32 {
                    ...
                    match event_code {
                        0 => {
                            if ((*message).ProfileEntry.len() as i32) < 24 as i32 {
                                let fresh20 = (*message).ProfileEntry.len();
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            decode_exi_type_uint32(
                                stream,
                                &mut (*DC_EVChargeParameterType).DepartureTime.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                ...
                if error == 0 as i32 {
                    match event_code {
                        ...
                        1 => {
                            decode_iso2_physical_value(
                                stream,
                                &mut (*DC_EVChargeParameterType).EVEnergyRequest.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            decode_exi_type_uint32(
                                stream,
                                &mut (*message).DepartureTime.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                        ...
                        1 => {
                            decode_iso2_ac_evcharge_parameter(
                                stream,
                                &mut (*message).AC_EVChargeParameter,
                            )?;
                            if error == 0 as i32 {
                    ...
                    match event_code {
                        0 => {
                            decode_iso2_dc_evcharge_parameter(
                                stream,
                                &mut (*message).DC_EVChargeParameter,
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                                ...
                                if event_code == 0 as i32 as u32 {
                                    ...
                                    if error == 0 as i32 {
                                        if (*message).ServiceScope.unwrap().len >= 2 {
                                            ...
                                            exi_basetypes_decoder_characters(
                                                stream,
                                                (*message).ServiceScope.unwrap().len() as usize,
                    ...
                    match event_code {
                        0 => {
                            decode_iso2_supported_energy_transfer_mode(
                                stream,
                                &mut (*message).SupportedEnergyTransferMode,
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
...
pub fn decode_iso2_ev_power_delivery_parameter(
    stream: &mut ExiBitstream,
	message: &mut Iso2EVPowerDeliveryParameterType,
) -> Result<(), ExiError> {
    let mut event_code: u32 = 0;
    exi_basetypes_decoder_nbit_uint(stream, 1, &mut event_code)?;
    if event_code != 0 as i32 as u32 {
        ...
        match grammar_id {
            162 => {
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            exi_basetypes_decoder_uint_16(stream, &mut ((*message).id.len() as u16))?;
                            if error == 0 as i32 {
                                if (*message).id.len >= 2 {
                                    (*message).id.len -= 2;
...
pub fn decode_iso2_evse_charge_parameter(
    stream: &mut ExiBitstream,
	message: &mut Iso2EVSEChargeParameterType,
) -> Result<(), ExiError> {
    let mut event_code: u32 = 0;
    exi_basetypes_decoder_nbit_uint(stream, 1, &mut event_code)?;
    if event_code != 0 as i32 as u32 {
                    ...
                    match event_code {
                        0 => {
                            if ((*message).Service.len() as i32) < 8 as i32 {
                                ...
                                (*message).Service.len() =
                                    ((*message).Service.len()).wrapping_add(1);
                    ...
                    match event_code {
                        0 => {
                            ...
                            exi_basetypes_decoder_bytes(
                                ...
                                &mut DiffieHellmanPublickeyType.CONTENT,
                            )?;
                            grammar_id = 3 as i32;
                        }
                        _ => {
        ...
        match grammar_id {
            182 => {
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            decode_exi_type_uint16(stream, &mut (*message).NotificationMaxDelay)?;
                            if error == 0 as i32 {
                        ...
                        0 => {
                            ...
                            if error == 0 as i32 {
                                if event_code == 0 as i32 as u32 {
                                    exi_basetypes_decoder_uint_16(
                                        stream,
                                        &mut ((*message).MeterID.len() as u16),
                                    )?;
                                    if error == 0 as i32 {
                                        if (*message).MeterID.len >= 2 {
                                            (*message).MeterID.len -= 2;
                                            exi_basetypes_decoder_characters(
                                                stream,
                                                (*message).MeterID.len() as usize,
                                                &mut (*message).MeterID,
                                                33,
                                            )?;
                                        } else {
                    ...
                    match event_code {
                        0 => {
                            decode_exi_type_uint64(
                                stream,
                                &mut (*message).MeterReading.unwrap().clone(),
                            )?;
                        ...
                        1 => {
                            decode_exi_type_hex_binary(
                                stream,
                                &mut (*message).SigMeterReading.unwrap().len(),
                                &mut (*message).SigMeterReading.unwrap(),
                            )?;
                            if error == 0 as i32 {
                        ...
                        2 => {
                            decode_exi_type_integer16(
                                stream,
                                &mut (*message).MeterStatus.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                        ...
                        0 => {
                            ...
                            if error == 0 as i32 {
                                if event_code == 0 as i32 as u32 {
                                    ...
                                    if error == 0 as i32 {
                                        (*message).ChargeProgress = value as Iso2ChargeProgressType;
                                    }
                                } else {
                                    return Err(ExiError::UnsupportedSubEvent);
                                }
                    ...
                    match event_code {
                        0 => {
                            decode_iso2_charging_profile(
                                stream,
                                &mut (*message).ChargingProfile.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                        ...
                        1 => {
                            decode_iso2_DC_EVPowerDeliveryParameter(
                                stream,
                                &mut (*message).DC_EVPowerDeliveryParameter.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                        ...
                        2 => {
                            decode_iso2_evpower_delivery_parameter(
                                stream,
                                &mut (*message).EVPowerDeliveryParameter.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
        ...
        match grammar_id {
            ...
            204 => {
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            decode_iso2_physical_value(stream, &mut (*message).EVSEPresentCurrent)?;
                            if error == 0 as i32 {
                        ...
                        0 => {
                            ...
                            if error == 0 as i32 {
                                if event_code == 0 as i32 as u32 {
                                    ...
                                    if error == 0 as i32 {
                                        (*message).EVSECurrentLimitAchieved = value_0 as i32;
                                    }
                                } else {
                                    return Err(ExiError::UnsupportedSubEvent);
                                }
                        ...
                        0 => {
                            ...
                            if error == 0 as i32 {
                                if event_code == 0 as i32 as u32 {
                                    ...
                                    if error == 0 as i32 {
                                        (*message).EVSEVoltageLimitAchieved = value_1 as i32;
                                    }
                                } else {
                                    return Err(ExiError::UnsupportedSubEvent);
                                }
                        ...
                        0 => {
                            ...
                            if error == 0 as i32 {
                                if event_code == 0 as i32 as u32 {
                                    ...
                                    if error == 0 as i32 {
                                        (*message).EVSEPowerLimitAchieved = value_2 as i32;
                                    }
                                } else {
                                    return Err(ExiError::UnsupportedSubEvent);
                                }
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            decode_iso2_physical_value(
                                stream,
                                &mut (*message).EVSEMaximumVoltageLimit.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                    ...
                    match event_code {
                        0 => {
                            decode_iso2_meter_info(
                                stream,
                                &mut (*message).MeterInfo.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                        ...
                        1 => {
                            ...
                            if error == 0 as i32 {
                                if event_code == 0 as i32 as u32 {
                                    ...
                                    if error == 0 as i32 {
                                        (*message).ReceiptRequired = Some(value_4 as i32);
                                    }
                                } else {
                                    return Err(ExiError::UnsupportedSubEvent);
                                }
                        ...
                        0 => {
                            ...
                            if error == 0 as i32 {
                                if event_code == 0 as i32 as u32 {
                                    ...
                                    if error == 0 as i32 {
                                        (*message).ReceiptRequired = Some(value_5 as i32);
                                    }
                                } else {
                                    return Err(ExiError::UnsupportedSubEvent);
                                }
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            decode_iso2_physical_value(
                                stream,
                                &mut (*message).EVSEMaxCurrent.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                        ...
                        2 => {
                            ...
                            if error == 0 as i32 {
                                if event_code == 0 as i32 as u32 {
                                    ...
                                    if error == 0 as i32 {
                                        (*message).ReceiptRequired = Some(value_1 as i32);
                                    }
                                } else {
                                    return Err(ExiError::UnsupportedSubEvent);
                                }
                        ...
                        1 => {
                            ...
                            if error == 0 as i32 {
                                if event_code == 0 as i32 as u32 {
                                    ...
                                    if error == 0 as i32 {
                                        (*message).ReceiptRequired = Some(value_2 as i32);
                                    }
                                } else {
                                    return Err(ExiError::UnsupportedSubEvent);
                                }
                        ...
                        0 => {
                            ...
                            if error == 0 as i32 {
                                if event_code == 0 as i32 as u32 {
                                    ...
                                    if error == 0 as i32 {
                                        (*message).ReceiptRequired = Some(value_3 as i32);
                                    }
                                } else {
                                    return Err(ExiError::UnsupportedSubEvent);
                                }
                ...
                if error == 0 as i32 {
                    match event_code {
                        ...
                        1 => {
                            decode_exi_type_hex_binary(
                                stream,
                                &mut (*message).gen_challenge.unwrap().len(),
                                &mut (*message).gen_challenge.unwrap(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            decode_iso2_dc_ev_status(
                                stream,
                                &mut (*message).dc_ev_status.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            decode_iso2_physical_value(
                                stream,
                                &mut (*message).ev_target_voltage.clone().unwrap(),
                            )?;
                            if error == 0 as i32 {
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            decode_iso2_physical_value(
                                stream,
                                &mut (*message).ev_target_current.clone().unwrap(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                    ...
                    match event_code {
                        0 => {
                            decode_iso2_service_parameter_list(
                                stream,
                                &mut (*message).ServiceParameterList.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                        ...
                        0 => {
                            ...
                            if error == 0 as i32 {
                                if event_code == 0 as i32 as u32 {
                                    ...
                                    if error == 0 as i32 {
                                        if (*message).evse_id.len() as i32 >= 2 as i32 {
                                            exi_basetypes_decoder_characters(
                                                stream,
                                                (*message).evse_id.len(),
                                                &mut (*message).evse_id,
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            decode_exi_type_integer64(
                                stream,
                                &mut (*message).evse_time_stamp.clone().unwrap(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            decode_exi_type_integer16(
                                stream,
                                &mut (*message).retry_counter.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            ...
                            if error == 0 as i32 {
                                if (*message).id.clone().unwrap().len() as i32 >= 2 as i32 {
                                    exi_basetypes_decoder_characters(
                                        stream,
                ...
                if error == 0 as i32 {
                    match event_code {
                        0 => {
                            decode_iso2_ac_evse_status(
                                stream,
                                &mut (*message).ac_evse_status.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                        ...
                        1 => {
                            decode_iso2_dc_evse_status(
                                stream,
                                &mut (*message).dc_evse_status.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                        ...
                        2 => {
                            decode_iso2_evse_status(
                                stream,
                                &mut (*message).evse_status.unwrap().clone(),
                            )?;
                            if error == 0 as i32 {
                                grammar_id = 3 as i32;
                            }
                        ...
                        0 => {
                            ...
                            if error == 0 as i32 {
                                if event_code == 0 as i32 as u32 {
                                    ...
                                    if error == 0 as i32 {
                                        if (*message).service_scope.clone().unwrap().len() as i32 >= 2 as i32 {

                                            exi_basetypes_decoder_characters(
                                                stream,
                                                (*message).service_scope.clone().unwrap().len(),
...
pub fn decode_iso2_body(
    ...
    match event_code {
        ...
        15 => {
            ...
            message.body_type_component = Iso2BodyTypeEnum::MeteringReceiptReq(metering_receipt_req);
        }
        16 => {
            ...
            message.body_type_component = Iso2BodyTypeEnum::MeteringReceiptRes(metering_receipt_res);
        }
        17 => {
        ...
        27 => {
            ...
            message.body_type_component = Iso2BodyTypeEnum::ServiceDiscoveryReq(service_discovery_req);
        }
        28 => {
            ...
            message.body_type_component = Iso2BodyTypeEnum::ServiceDiscoveryRes(service_discovery_res);
        }
        29 => {
        ...
        33 => {
            ...
            message.body_type_component = Iso2BodyTypeEnum::WeldingDetectionReq(welding_detection_req);
        }
        34 => {
            ...
            message.body_type_component = Iso2BodyTypeEnum::WeldingDetectionRes(welding_detection_res);
        }
        _ => {
            return Err(ExiError::UnknownEventCode);
        }
...
pub fn decode_iso2_xmldsig_fragment(
    ...
    //         decode_iso2_KeyValue(
    //             stream,
    //             &mut (*message).XmlDSigComponents.KeyValue,
    //         )?;
    //         (*message).set_KeyValue_isUsed(1 as u32);
    //     }
    //     11 => {}
    //     12 => {}
    //     13 => {}
    ...
    //     16 => {
    //         error =
    //             decode_iso2_PGPData(stream, &mut (*message).XmlDSigComponents.PGPData);
    //         (*message).set_PGPData_isUsed(1 as u32);
    //     }
    //     17 => {}
    //     18 => {}
    //     19 => {}
    ...
    //             stream,
    //             &mut (*message).XmlDSigComponents.RSAKeyValue,
    //         )?;
    //         (*message).set_RSAKeyValue_isUsed(1 as u32);
    //     }
    //     22 => {
    ...
    //         decode_iso2_RetrievalMethod(
    //             stream,
    //             &mut (*message).XmlDSigComponents.RetrievalMethod,
    //         )?;
    //         (*message).set_RetrievalMethod_isUsed(1 as u32);
    //     }
    //     24 => {
    //         decode_iso2_SPKIData(
    //             stream,
    //             &mut (*message).XmlDSigComponents.SPKIData,
    //         )?;
    //         (*message).set_SPKIData_isUsed(1 as u32);
    //     }
    //     25 => {}
    //     26 => {}
    //     27 => {
    ...
    //             stream,
    //             &mut (*message).XmlDSigComponents.X509Data,
    //         )?;
    //         (*message).set_X509Data_isUsed(1 as u32);
    //     }
    //     38 => {}
    //     39 => {
    //         decode_iso2_X509IssuerSerial(
