...
use crate::lib::cbv2g::common::exi_basetypes::ExiSigned;
...
pub const ISO2_DC_EVERROR_CODE_TYPE_FAILED_CHARGING_SYSTEM_INCOMPATIBILITY: Iso2DcEvErrorCodeType = 10;
...
pub const ISO2_DC_EVSESTATUS_CODE_TYPE_EVSE_ISOLATION_MONITORING_ACTIVE: Iso2DcEvseStatusCodeType = 4;
...
pub const ISO2_RESPONSE_CODE_TYPE_FAILED_CERTIFICATE_NOT_ALLOWED_AT_THIS_EVSE: Iso2ResponseCodeType = 24;
...
pub const ISO2_EVSEPROCESSING_TYPE_ONGOING_WAITING_FOR_CUSTOMER_INTERACTION: Iso2EvseProcessingType = 2;
...
impl Default for Iso2CertificateInstallationResType {
    fn default() -> Self {
        Iso2CertificateInstallationResType {
            ...
            ContractSignatureCertChain: Iso2CertificateChainType::default(),
            ContractSignatureEncryptedPrivateKey: Iso2ContractSignatureEncryptedPrivateKeyType::default(),
